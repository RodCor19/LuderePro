...
{*<!--<input type="text" name="server" data-validation-engine='validate[required]' value="" />-->*}
<div class="container-fluid" id="AnnouncementContainer">
    <div class="widget_header row-fluid">
        <div class="span8">
        ...
        <table class="table table-bordered table-condensed themeTableColor">
            <thead>
                <tr class="blockHeader">
                    <th colspan="2" class="">
                        <span class="alignMiddle">{vtranslate('LBL_DBCONECTION', $QUALIFIED_MODULE)}</span>
                    </th>
                </tr>
            </thead>
            <tbody>
    ...
    <hr>
    <div id='table' class="contents row-fluid ">
