...
INSERT IGNORE INTO `com_vtiger_workflows` (`workflow_id`, `module_name`, `summary`, `test`, `execution_condition`, `defaultworkflow`, `type`, `filtersavedinnew`, `schtypeid`, `schdayofmonth`, `schdayofweek`, `schannualdates`, `schtime`, `nexttrigger_time`) VALUES
...
-- Volcando datos para la tabla vtiger.com_vtiger_workflowtasks_entitymethod: ~9 rows (aproximadamente)
...
-- Volcando estructura para tabla vtiger.vtiger_accmcontacto
CREATE TABLE IF NOT EXISTS `vtiger_accmcontacto` (
  `accmcontactoid` int(11) NOT NULL AUTO_INCREMENT,
  `accmcontacto` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0',
  PRIMARY KEY (`accmcontactoid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_accmcontacto: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_accmcontacto` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_accmcontacto` (`accmcontactoid`, `accmcontacto`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Gestión proactiva', 1, 308, 1),
	(2, 'Referido', 1, 309, 2),
	(3, 'Intermediario', 1, 310, 3),
	(4, 'Espontáneo Cliente', 1, 311, 4),
	(5, 'Otro', 1, 312, 5);
/*!40000 ALTER TABLE `vtiger_accmcontacto` ENABLE KEYS */;

-- Volcando estructura para tabla vtiger.vtiger_accmcontacto_seq
CREATE TABLE IF NOT EXISTS `vtiger_accmcontacto_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_accmcontacto_seq: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_accmcontacto_seq` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_accmcontacto_seq` (`id`) VALUES
	(5);
/*!40000 ALTER TABLE `vtiger_accmcontacto_seq` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `vtiger_account` (
  ...
  `accrsocial` varchar(20) DEFAULT NULL,
  `accrut` varchar(12) DEFAULT NULL,
  `acctcompra` varchar(100) DEFAULT NULL,
  `acctatencion` varchar(100) DEFAULT NULL,
  `accisproveedor` bit(1) DEFAULT NULL,
  `accmcontacto` varchar(100) DEFAULT NULL,
  `accmcotro` text,
  `accmcreferido` varchar(75) DEFAULT NULL,
  `accmccombo` varchar(100) DEFAULT NULL,
  `accredsocialtwitter` varchar(50) DEFAULT NULL,
  `accredsocialfacebook` varchar(100) DEFAULT NULL,
  `accredsocialinstagram` varchar(50) DEFAULT NULL,
  `accredsociallinkedin` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`accountid`),
  KEY `account_account_type_idx` (`account_type`),
  KEY `email_idx` (`email1`,`email2`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_account: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_account` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_account` (`accountid`, `account_no`, `accountname`, `parentid`, `account_type`, `industry`, `annualrevenue`, `rating`, `ownership`, `siccode`, `tickersymbol`, `phone`, `otherphone`, `email1`, `email2`, `website`, `fax`, `employees`, `emailoptout`, `notify_owner`, `isconvertedfromlead`, `accrsocial`, `accrut`, `acctcompra`, `acctatencion`, `accisproveedor`, `accmcontacto`, `accmcotro`, `accmcreferido`, `accmccombo`, `accredsocialtwitter`, `accredsocialfacebook`, `accredsocialinstagram`, `accredsociallinkedin`) VALUES
	(26, 'ACC25', 'Rodrigo Correa', 0, 'Customer', 'Technology', 150000.00000000, 'Acquired', '', '123123', 'ROD', '47212345', '', 'rodrigo@gmail.com', '', 'www.pagina.com', '', 1, '1', '0', '0', '123456', '123123', 'Compra Anual |##| Compra Semestral', 'A traves de agencia', b'1', 'Referido', '', 'Yo', '', '', '', '', '');
...
-- Volcando datos para la tabla vtiger.vtiger_accountbillads: ~25 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_accountscf: ~23 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_accountscf` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_accountscf` (`accountid`) VALUES
	(2),
	(3),
	(4),
	(5),
...
-- Volcando datos para la tabla vtiger.vtiger_accountshipads: ~25 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_accounttype: ~11 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_accounttype` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_accounttype` (`accounttypeid`, `accounttype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Analyst', 1, 2, 1),
	(3, 'Competitor', 1, 3, 2),
	(4, 'Customer', 1, 4, 3),
	(5, 'Integrator', 1, 5, 4),
...
-- Volcando estructura para tabla vtiger.vtiger_acctatencion
CREATE TABLE IF NOT EXISTS `vtiger_acctatencion` (
  `acctatencionid` int(11) NOT NULL AUTO_INCREMENT,
  `acctatencion` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0',
  PRIMARY KEY (`acctatencionid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_acctatencion: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_acctatencion` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_acctatencion` (`acctatencionid`, `acctatencion`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Atención directa', 1, 306, 1),
	(2, 'A través de agencia', 1, 307, 2);
/*!40000 ALTER TABLE `vtiger_acctatencion` ENABLE KEYS */;

-- Volcando estructura para tabla vtiger.vtiger_acctatencion_seq
CREATE TABLE IF NOT EXISTS `vtiger_acctatencion_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_acctatencion_seq: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_acctatencion_seq` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_acctatencion_seq` (`id`) VALUES
	(2);
/*!40000 ALTER TABLE `vtiger_acctatencion_seq` ENABLE KEYS */;

-- Volcando estructura para tabla vtiger.vtiger_acctcompra
CREATE TABLE IF NOT EXISTS `vtiger_acctcompra` (
  `acctcompraid` int(11) NOT NULL AUTO_INCREMENT,
  `acctcompra` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0',
  PRIMARY KEY (`acctcompraid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_acctcompra: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_acctcompra` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_acctcompra` (`acctcompraid`, `acctcompra`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Compra Anual', 1, 303, 1),
	(2, 'Compra Semestral', 1, 304, 2),
	(3, 'Compra de CP', 1, 305, 3);
/*!40000 ALTER TABLE `vtiger_acctcompra` ENABLE KEYS */;

-- Volcando estructura para tabla vtiger.vtiger_acctcompra_seq
CREATE TABLE IF NOT EXISTS `vtiger_acctcompra_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_acctcompra_seq: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_acctcompra_seq` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_acctcompra_seq` (`id`) VALUES
	(3);
/*!40000 ALTER TABLE `vtiger_acctcompra_seq` ENABLE KEYS */;
...
-- Volcando datos para la tabla vtiger.vtiger_actionmapping: ~22 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_activitytype` (`activitytypeid`, `activitytype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Call', 0, 12, 0),
	(2, 'Meeting', 0, 13, 1),
...
INSERT IGNORE INTO `vtiger_assetstatus` (`assetstatusid`, `assetstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_blocks` (`blockid`, `tabid`, `blocklabel`, `sequence`, `show_title`, `visible`, `create_view`, `edit_view`, `detail_view`, `display_status`, `iscustom`) VALUES
	...
	(120, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 5, 0, 0, 0, 0, 0, 1, 0),
	(121, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 6, 0, 0, 0, 0, 0, 1, 0);
...
INSERT IGNORE INTO `vtiger_calendar_default_activitytypes` (`id`, `module`, `fieldname`, `defaultcolor`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_campaignrelstatus: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_campaignrelstatus` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_campaignrelstatus` (`campaignrelstatusid`, `campaignrelstatus`, `sortorderid`, `presence`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_campaignstatus: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_campaignstatus` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_campaignstatus` (`campaignstatusid`, `campaignstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Planning', 1, 15, 1),
	(3, 'Active', 1, 16, 2),
	(4, 'Inactive', 1, 17, 3),
	(5, 'Completed', 1, 18, 4),
...
-- Volcando datos para la tabla vtiger.vtiger_campaigntype: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_campaigntype` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_campaigntype` (`campaigntypeid`, `campaigntype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Conference', 1, 21, 1),
	(3, 'Webinar', 1, 22, 2),
	(4, 'Trade Show', 1, 23, 3),
...
INSERT IGNORE INTO `vtiger_carrier` (`carrierid`, `carrier`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'FedEx', 1, 33, 0),
	(2, 'UPS', 1, 34, 1),
	(3, 'USPS', 1, 35, 2),
	(4, 'DHL', 1, 36, 3),
...
INSERT IGNORE INTO `vtiger_contract_priority` (`contract_priorityid`, `contract_priority`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Low', 1, 220, 1),
	(2, 'Normal', 1, 221, 2),
	(3, 'High', 1, 222, 3);
...
INSERT IGNORE INTO `vtiger_contract_status` (`contract_statusid`, `contract_status`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Undefined', 1, 214, 1),
...
INSERT IGNORE INTO `vtiger_contract_type` (`contract_typeid`, `contract_type`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Support', 1, 223, 1),
	(2, 'Services', 1, 224, 2),
...
-- Volcando datos para la tabla vtiger.vtiger_convertleadmapping: ~31 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_crmentity: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_crmentity` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_crmentity` (`crmid`, `smcreatorid`, `smownerid`, `modifiedby`, `setype`, `description`, `createdtime`, `modifiedtime`, `viewedtime`, `status`, `version`, `presence`, `deleted`, `label`) VALUES
	(26, 1, 1, 1, 'Accounts', '', '2018-10-26 06:00:45', '2018-10-26 06:00:45', NULL, NULL, 0, 1, 0, 'Rodrigo Correa');
...
-- Volcando datos para la tabla vtiger.vtiger_customerportal_fields: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_customerportal_prefs: ~15 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_customerportal_tabs: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_customerportal_tabs` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_customerportal_tabs` (`tabid`, `visible`, `sequence`) VALUES
	(4, 1, 9),
	(6, 1, 10),
	(8, 1, 8),
	(13, 1, 2),
...
-- Volcando datos para la tabla vtiger.vtiger_cvcolumnlist: ~264 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_date_format: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_def_org_field: ~692 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_def_org_share: ~24 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_duration_minutes` (`minutesid`, `duration_minutes`, `sortorderid`, `presence`) VALUES
	(1, '00', 0, 1),
	(2, '15', 1, 1),
	(3, '30', 2, 1),
	(4, '45', 3, 1);
...
-- Volcando datos para la tabla vtiger.vtiger_emailtemplates: ~12 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_emailtemplates` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_emailtemplates` (`foldername`, `templatename`, `subject`, `description`, `body`, `deleted`, `templateid`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_entityname: ~26 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_eventhandlers: ~23 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_eventstatus` (`eventstatusid`, `eventstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Planned', 0, 38, 0),
	(2, 'Held', 0, 39, 1),
	(3, 'Not Held', 0, 40, 2);
...
-- Volcando datos para la tabla vtiger.vtiger_expectedresponse: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_expectedresponse` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_expectedresponse` (`expectedresponseid`, `expectedresponse`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Excellent', 1, 42, 1),
	(3, 'Good', 1, 43, 2),
	(4, 'Average', 1, 44, 3),
	(5, 'Poor', 1, 45, 4);
...
-- Volcando datos para la tabla vtiger.vtiger_faqcategories: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_faqcategories` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_faqcategories` (`faqcategories_id`, `faqcategories`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'General', 1, 46, 0);
...
INSERT IGNORE INTO `vtiger_faqstatus` (`faqstatus_id`, `faqstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Draft', 0, 47, 0),
	(2, 'Reviewed', 0, 48, 1),
	(3, 'Published', 0, 49, 2),
	(4, 'Obsolete', 0, 50, 3);
...
-- Volcando datos para la tabla vtiger.vtiger_field: ~724 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_field` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_field` (`tabid`, `fieldid`, `columnname`, `tablename`, `generatedtype`, `uitype`, `fieldname`, `fieldlabel`, `readonly`, `presence`, `defaultvalue`, `maximumlength`, `sequence`, `block`, `displaytype`, `typeofdata`, `quickcreate`, `quickcreatesequence`, `info_type`, `masseditable`, `helpinfo`, `summaryfield`) VALUES
	...
	(6, 751, 'accrsocial', 'vtiger_account', 1, '1', 'accrsocial', 'accrsocial', 1, 2, '', 100, 1, 120, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 752, 'accrut', 'vtiger_account', 1, '1', 'accrut', 'accrut', 1, 2, '', 100, 2, 120, 1, 'N~M', 1, 0, 'BAS', 1, '', 0),
	(6, 753, 'acctcompra', 'vtiger_account', 1, '33', 'acctcompra', 'acctcompra', 1, 2, '', 100, 3, 120, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 754, 'acctatencion', 'vtiger_account', 1, '33', 'acctatencion', 'acctatencion', 1, 2, '', 100, 4, 120, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 755, 'accisproveedor', 'vtiger_account', 1, '56', 'accisproveedor', 'accisproveedor', 1, 2, '', 100, 5, 120, 1, 'C~O', 1, 0, 'BAS', 1, '', 0),
	(6, 756, 'accmcontacto', 'vtiger_account', 1, '15', 'accmcontacto', 'accmcontacto', 1, 2, '', 100, 6, 120, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 757, 'accmcotro', 'vtiger_account', 1, '1', 'accmcotro', 'accmcotro', 1, 2, '', 100, 7, 120, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 758, 'accmcreferido', 'vtiger_account', 1, '1', 'accmcreferido', 'accmcreferido', 1, 2, '', 100, 8, 120, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 759, 'accmccombo', 'vtiger_account', 1, '15', 'accmccombo', 'accmccombo', 1, 2, '', 100, 9, 120, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 760, 'accredsocialtwitter', 'vtiger_account', 1, '1', 'accredsocialtwitter', 'accredsocialtwitter', 1, 2, '', 100, 1, 121, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 761, 'accredsocialfacebook', 'vtiger_account', 1, '1', 'accredsocialfacebook', 'accredsocialfacebook', 1, 2, '', 100, 2, 121, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 762, 'accredsocialinstagram', 'vtiger_account', 1, '1', 'accredsocialinstagram', 'accredsocialinstagram', 1, 2, '', 100, 3, 121, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 763, 'accredsociallinkedin', 'vtiger_account', 1, '1', 'accredsociallinkedin', 'accredsociallinkedin', 1, 2, '', 100, 4, 121, 1, 'V~O', 1, 0, 'BAS', 1, '', 0);
...
-- Volcando datos para la tabla vtiger.vtiger_fieldmodulerel: ~45 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_glacct` (`glacctid`, `glacct`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
-- Volcando estructura para tabla vtiger.vtiger_google_sync
...
-- Volcando datos para la tabla vtiger.vtiger_google_sync: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_industry: ~32 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_industry` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_industry` (`industryid`, `industry`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Apparel', 1, 61, 1),
	(3, 'Banking', 1, 62, 2),
...
INSERT IGNORE INTO `vtiger_inventorytaxinfo` (`taxid`, `taxname`, `taxlabel`, `percentage`, `deleted`) VALUES
	(1, 'tax1', 'VAT', 4.500, 0),
...
-- Volcando datos para la tabla vtiger.vtiger_inventory_tandc: ~0 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_invoicestatus` (`invoicestatusid`, `invoicestatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_language` (`id`, `name`, `prefix`, `label`, `lastupdated`, `sequence`, `isdefault`, `active`) VALUES
	(1, 'English', 'en_us', 'US English', '2018-10-17 16:16:10', NULL, 1, 1),
	(2, 'Arabic', 'ar_ae', 'Arabic', '2018-10-17 16:27:58', NULL, 0, 1),
	(3, 'Brazilian', 'pt_br', 'PT Brasil', '2018-10-17 16:24:56', NULL, 0, 1),
	(4, 'British English', 'en_gb', 'British English', '2018-10-17 16:23:15', NULL, 0, 1),
	(5, 'Deutsch', 'de_de', 'DE Deutsch', '2018-10-17 16:23:19', NULL, 0, 1),
	(6, 'Dutch', 'nl_nl', 'NL-Dutch', '2018-10-17 16:23:21', NULL, 0, 1),
	(7, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2018-10-17 16:24:57', NULL, 0, 1),
	(8, 'Hungarian', 'hu_hu', 'HU Magyar', '2018-10-17 16:23:29', NULL, 0, 1),
	(9, 'Italian', 'it_it', 'IT Italian', '2018-10-17 16:23:30', NULL, 0, 1),
	(10, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2018-10-17 16:23:31', NULL, 0, 1),
	(11, 'Język Polski', 'pl_pl', 'Język Polski', '2018-10-17 16:24:59', NULL, 0, 1),
	(12, 'Romana', 'ro_ro', 'Romana', '2018-10-17 16:24:58', NULL, 0, 1),
	(13, 'Russian', 'ru_ru', 'Russian', '2018-10-17 16:24:32', NULL, 0, 1),
	(14, 'Spanish', 'es_es', 'ES Spanish', '2018-10-17 16:24:42', NULL, 0, 1),
	(15, 'Swedish', 'sv_se', 'Swedish', '2018-10-17 16:27:59', NULL, 0, 1),
	(16, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2018-10-17 16:24:46', NULL, 0, 1);
...
-- Volcando datos para la tabla vtiger.vtiger_leadsource: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_leadsource` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_leadsource` (`leadsourceid`, `leadsource`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Cold Call', 1, 99, 1),
...
-- Volcando datos para la tabla vtiger.vtiger_leadstatus: ~12 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_leadstatus` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_leadstatus` (`leadstatusid`, `leadstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_links: ~72 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_links` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_links` (`linkid`, `tabid`, `linktype`, `linklabel`, `linkurl`, `linkicon`, `sequence`, `handler_path`, `handler_class`, `handler`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_loginhistory: ~17 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_loginhistory` (`login_id`, `user_name`, `user_ip`, `logout_time`, `login_time`, `status`) VALUES
	(1, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-17 15:28:51', 'Signed in'),
	(2, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-17 16:55:53', 'Signed in'),
	(3, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-17 16:55:54', 'Signed in'),
	(4, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-18 15:31:07', 'Signed in'),
	(5, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-18 15:38:21', 'Signed in'),
	(6, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-18 15:56:25', 'Signed in'),
	(7, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-19 05:12:20', 'Signed in'),
	(8, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-20 22:10:19', 'Signed in'),
	(9, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-21 20:47:14', 'Signed in'),
	(10, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-22 17:19:28', 'Signed in'),
	(11, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-23 17:32:25', 'Signed in'),
	(12, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-24 15:35:52', 'Signed in'),
	(13, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-24 15:36:39', 'Signed in'),
	(14, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-25 20:04:13', 'Signed in'),
	(15, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-26 04:11:57', 'Signed in'),
	(16, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-26 04:12:05', 'Signed in'),
	(17, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-26 04:36:05', 'Signed in');
...
-- Volcando datos para la tabla vtiger.vtiger_manufacturer: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_manufacturer` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_manufacturer` (`manufacturerid`, `manufacturer`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_modentity_num: ~18 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_modtracker_basic: ~37 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_modtracker_basic` (`id`, `crmid`, `module`, `whodid`, `changedon`, `status`) VALUES
	(1, 2, 'Accounts', 1, '2018-10-17 17:01:35', 2),
	(2, 3, 'Accounts', 1, '2018-10-17 17:46:55', 2),
	(3, 4, 'Accounts', 1, '2018-10-17 17:55:55', 2),
	(4, 5, 'Accounts', 1, '2018-10-17 19:11:33', 2),
	(5, 4, 'Accounts', 1, '2018-10-17 19:16:49', 1),
	(6, 5, 'Accounts', 1, '2018-10-17 19:16:57', 1),
	(7, 6, 'Accounts', 1, '2018-10-17 19:17:54', 2),
	(8, 6, 'Accounts', 1, '2018-10-17 19:21:30', 1),
	(9, 7, 'Accounts', 1, '2018-10-17 19:27:21', 2),
	(10, 8, 'Accounts', 1, '2018-10-17 19:28:48', 2),
	(11, 9, 'Accounts', 1, '2018-10-18 04:33:06', 2),
	(12, 9, 'Accounts', 1, '2018-10-18 04:34:41', 1),
	(13, 7, 'Accounts', 1, '2018-10-18 04:34:47', 1),
	(14, 8, 'Accounts', 1, '2018-10-18 04:34:54', 1),
	(15, 10, 'Accounts', 1, '2018-10-18 04:35:52', 2),
	(16, 10, 'Accounts', 1, '2018-10-18 04:36:06', 1),
	(17, 11, 'Accounts', 1, '2018-10-18 04:37:09', 2),
	(18, 12, 'Accounts', 1, '2018-10-18 04:42:50', 2),
	(19, 13, 'Accounts', 1, '2018-10-18 04:43:25', 2),
	(20, 14, 'Accounts', 1, '2018-10-18 04:45:40', 2),
	(21, 15, 'Accounts', 1, '2018-10-18 04:51:39', 2),
	(22, 16, 'Accounts', 1, '2018-10-18 04:54:56', 2),
	(23, 17, 'Accounts', 1, '2018-10-18 15:13:56', 2),
	(24, 18, 'Accounts', 1, '2018-10-18 15:20:38', 2),
	(25, 19, 'Accounts', 1, '2018-10-18 15:22:47', 2),
	(26, 20, 'Accounts', 1, '2018-10-18 15:35:48', 2),
	(27, 21, 'Accounts', 1, '2018-10-18 15:53:35', 2),
	(28, 21, 'Accounts', 1, '2018-10-18 15:56:41', 1),
	(29, 22, 'Accounts', 1, '2018-10-18 15:57:15', 2),
	(30, 23, 'Accounts', 1, '2018-10-18 16:07:26', 2),
	(31, 23, 'Accounts', 1, '2018-10-19 05:13:24', 0),
	(32, 23, 'Accounts', 1, '2018-10-19 05:36:11', 0),
	(33, 23, 'Accounts', 1, '2018-10-19 05:36:18', 0),
	(34, 23, 'Accounts', 1, '2018-10-19 05:40:25', 0),
	(35, 23, 'Accounts', 1, '2018-10-19 05:40:32', 0),
	(36, 23, 'Accounts', 1, '2018-10-19 05:40:40', 0),
	(37, 23, 'Accounts', 1, '2018-10-19 05:43:53', 0),
	(38, 23, 'Accounts', 1, '2018-10-19 05:47:46', 0),
	(39, 24, 'Accounts', 1, '2018-10-19 06:14:52', 2),
	(40, 25, 'Accounts', 1, '2018-10-26 05:36:36', 2),
	(41, 26, 'Accounts', 1, '2018-10-26 06:00:45', 2);
...
-- Volcando datos para la tabla vtiger.vtiger_modtracker_detail: ~445 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_modtracker_detail` (`id`, `fieldname`, `prevalue`, `postvalue`) VALUES
	(1, 'accountname', NULL, 'Pepito'),
	(1, 'account_no', NULL, 'ACC1'),
	(1, 'phone', NULL, '47221113'),
	(1, 'website', NULL, 'www.aaa.com'),
	(1, 'tickersymbol', NULL, 'PEP'),
	(1, 'email1', NULL, 'iclaCreyo@gmail.com'),
	(1, 'employees', NULL, '12'),
	(1, 'email2', NULL, 'iclaCreyo123@gmail.com'),
	(1, 'ownership', NULL, 'No'),
	(1, 'rating', NULL, 'Active'),
	(1, 'industry', NULL, 'Communications'),
	(1, 'siccode', NULL, '123123'),
	(1, 'accounttype', NULL, 'Analyst'),
	(1, 'annual_revenue', NULL, '200000.00000000'),
	(1, 'emailoptout', NULL, '1'),
	(1, 'assigned_user_id', NULL, '1'),
	(1, 'createdtime', NULL, '2018-10-17 17:01:35'),
	(1, 'modifiedby', NULL, '1'),
	(1, 'record_id', NULL, '2'),
	(1, 'record_module', NULL, 'Accounts'),
	(2, 'accountname', NULL, 'Juancho'),
	(2, 'account_no', NULL, 'ACC2'),
	(2, 'phone', NULL, '4721114'),
	(2, 'website', NULL, 'www.juancho.com'),
	(2, 'tickersymbol', NULL, 'Jua'),
	(2, 'email1', NULL, 'jua1@gmail.com'),
	(2, 'employees', NULL, '10'),
	(2, 'email2', NULL, 'jua2@gmail.com'),
	(2, 'ownership', NULL, 'S&iacute;'),
	(2, 'rating', NULL, 'Active'),
	(2, 'industry', NULL, 'Biotechnology'),
	(2, 'siccode', NULL, '123123'),
	(2, 'accounttype', NULL, 'Integrator'),
	(2, 'annual_revenue', NULL, '200000.00000000'),
	(2, 'emailoptout', NULL, '1'),
	(2, 'assigned_user_id', NULL, '1'),
	(2, 'createdtime', NULL, '2018-10-17 17:46:55'),
	(2, 'modifiedby', NULL, '1'),
	(2, 'accrsocial', NULL, '123456'),
	(2, 'accrut', NULL, '123123'),
	(2, 'acctcompra', NULL, 'Compra Anual'),
	(2, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(2, 'accisproveedor', NULL, '1'),
	(2, 'accmcontacto', NULL, 'Referido'),
	(2, 'accmcreferido', NULL, 'X'),
	(2, 'record_id', NULL, '3'),
	(2, 'record_module', NULL, 'Accounts'),
	(3, 'accountname', NULL, 'Roberto'),
	(3, 'account_no', NULL, 'ACC3'),
	(3, 'website', NULL, 'www.asdas.com'),
	(3, 'tickersymbol', NULL, 'RBT'),
	(3, 'employees', NULL, '12'),
	(3, 'rating', NULL, 'Active'),
	(3, 'industry', NULL, 'Biotechnology'),
	(3, 'siccode', NULL, '123123'),
	(3, 'accounttype', NULL, 'Integrator'),
	(3, 'annual_revenue', NULL, '200000.00000000'),
	(3, 'emailoptout', NULL, '1'),
	(3, 'assigned_user_id', NULL, '1'),
	(3, 'createdtime', NULL, '2018-10-17 17:55:55'),
	(3, 'modifiedby', NULL, '1'),
	(3, 'accrsocial', NULL, '564987'),
	(3, 'accrut', NULL, '123123'),
	(3, 'acctcompra', NULL, 'Compra Semestral'),
	(3, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(3, 'accisproveedor', NULL, '1'),
	(3, 'accmcontacto', NULL, 'Referido'),
	(3, 'accmcreferido', NULL, '123213'),
	(3, 'record_id', NULL, '4'),
	(3, 'record_module', NULL, 'Accounts'),
	(4, 'accountname', NULL, 'Roberto'),
	(4, 'account_no', NULL, 'ACC4'),
	(4, 'website', NULL, 'www.asdas.com'),
	(4, 'tickersymbol', NULL, 'RBT'),
	(4, 'employees', NULL, '12'),
	(4, 'rating', NULL, 'Active'),
	(4, 'industry', NULL, 'Biotechnology'),
	(4, 'siccode', NULL, '123123'),
	(4, 'accounttype', NULL, 'Integrator'),
	(4, 'annual_revenue', NULL, '200000.00000000'),
	(4, 'emailoptout', NULL, '1'),
	(4, 'assigned_user_id', NULL, '1'),
	(4, 'createdtime', NULL, '2018-10-17 19:11:33'),
	(4, 'modifiedby', NULL, '1'),
	(4, 'accrsocial', NULL, '564987'),
	(4, 'accrut', NULL, '123123'),
	(4, 'acctcompra', NULL, 'Compra Semestral'),
	(4, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(4, 'accisproveedor', NULL, '1'),
	(4, 'accmcontacto', NULL, 'Referido'),
	(4, 'accmcreferido', NULL, '123213'),
	(4, 'record_id', NULL, '5'),
	(4, 'record_module', NULL, 'Accounts'),
	(7, 'accountname', NULL, 'Robrto'),
	(7, 'account_no', NULL, 'ACC5'),
	(7, 'siccode', NULL, '123123'),
	(7, 'annual_revenue', NULL, '0.00000000'),
	(7, 'assigned_user_id', NULL, '1'),
	(7, 'createdtime', NULL, '2018-10-17 19:17:54'),
	(7, 'modifiedby', NULL, '1'),
	(7, 'accrsocial', NULL, '213123'),
	(7, 'accrut', NULL, '123123'),
	(7, 'acctcompra', NULL, 'Compra Semestral'),
	(7, 'acctatencion', NULL, 'Atenci&oacute;n directa |##| A trav&eacute;s de agencia'),
	(7, 'accisproveedor', NULL, '1'),
	(7, 'accmcontacto', NULL, 'Gesti&oacute;n proactiva'),
	(7, 'accmcreferido', NULL, '12312'),
	(7, 'record_id', NULL, '6'),
	(7, 'record_module', NULL, 'Accounts'),
	(9, 'accountname', NULL, 'PEPE'),
	(9, 'account_no', NULL, 'ACC6'),
	(9, 'siccode', NULL, '123123'),
	(9, 'annual_revenue', NULL, '0.00000000'),
	(9, 'assigned_user_id', NULL, '1'),
	(9, 'createdtime', NULL, '2018-10-17 19:27:21'),
	(9, 'modifiedby', NULL, '1'),
	(9, 'accrsocial', NULL, '123'),
	(9, 'accrut', NULL, '123123'),
	(9, 'acctcompra', NULL, 'Compra Semestral'),
	(9, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(9, 'accisproveedor', NULL, '1'),
	(9, 'accmcontacto', NULL, 'Otro'),
	(9, 'record_id', NULL, '7'),
	(9, 'record_module', NULL, 'Accounts'),
	(10, 'accountname', NULL, '123123123123'),
	(10, 'account_no', NULL, 'ACC7'),
	(10, 'siccode', NULL, '123123'),
	(10, 'annual_revenue', NULL, '0.00000000'),
	(10, 'assigned_user_id', NULL, '1'),
	(10, 'createdtime', NULL, '2018-10-17 19:28:48'),
	(10, 'modifiedby', NULL, '1'),
	(10, 'accrsocial', NULL, '132'),
	(10, 'accrut', NULL, '123'),
	(10, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(10, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(10, 'accisproveedor', NULL, '1'),
	(10, 'accmcontacto', NULL, 'Referido'),
	(10, 'record_id', NULL, '8'),
	(10, 'record_module', NULL, 'Accounts'),
	(11, 'accountname', NULL, 'hhhh'),
	(11, 'account_no', NULL, 'ACC8'),
	(11, 'website', NULL, 'www.hhhh.com'),
	(11, 'tickersymbol', NULL, '4h'),
	(11, 'siccode', NULL, '123123'),
	(11, 'annual_revenue', NULL, '0.00000000'),
	(11, 'assigned_user_id', NULL, '1'),
	(11, 'createdtime', NULL, '2018-10-18 04:33:06'),
	(11, 'modifiedby', NULL, '1'),
	(11, 'accrsocial', NULL, '12321'),
	(11, 'accrut', NULL, '123123'),
	(11, 'acctcompra', NULL, 'Compra Semestral'),
	(11, 'acctatencion', NULL, 'Atenci&oacute;n directa |##| A trav&eacute;s de agencia'),
	(11, 'accisproveedor', NULL, '1'),
	(11, 'accmcontacto', NULL, 'Otro'),
	(11, 'accmcotro', NULL, '123'),
	(11, 'record_id', NULL, '9'),
	(11, 'record_module', NULL, 'Accounts'),
	(15, 'accountname', NULL, 'Robert'),
	(15, 'account_no', NULL, 'ACC9'),
	(15, 'tickersymbol', NULL, 'ROB'),
	(15, 'siccode', NULL, '123123'),
	(15, 'annual_revenue', NULL, '0.00000000'),
	(15, 'assigned_user_id', NULL, '1'),
	(15, 'createdtime', NULL, '2018-10-18 04:35:52'),
	(15, 'modifiedby', NULL, '1'),
	(15, 'accrsocial', NULL, '123'),
	(15, 'accrut', NULL, '123123'),
	(15, 'acctcompra', NULL, 'Compra Semestral'),
	(15, 'acctatencion', NULL, 'Atenci&oacute;n directa |##| A trav&eacute;s de agencia'),
	(15, 'accisproveedor', NULL, '1'),
	(15, 'accmcontacto', NULL, 'Otro'),
	(15, 'accmcotro', NULL, '123'),
	(15, 'record_id', NULL, '10'),
	(15, 'record_module', NULL, 'Accounts'),
	(17, 'accountname', NULL, 'Robert'),
	(17, 'account_no', NULL, 'ACC10'),
	(17, 'siccode', NULL, '123123'),
	(17, 'annual_revenue', NULL, '0.00000000'),
	(17, 'assigned_user_id', NULL, '1'),
	(17, 'createdtime', NULL, '2018-10-18 04:37:09'),
	(17, 'modifiedby', NULL, '1'),
	(17, 'accrsocial', NULL, '123213'),
	(17, 'accrut', NULL, '123123'),
	(17, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(17, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(17, 'accisproveedor', NULL, '1'),
	(17, 'accmcontacto', NULL, 'Espont&aacute;neo Cliente'),
	(17, 'record_id', NULL, '11'),
	(17, 'record_module', NULL, 'Accounts'),
	(18, 'accountname', NULL, 'Robert Np'),
	(18, 'account_no', NULL, 'ACC11'),
	(18, 'siccode', NULL, '123123'),
	(18, 'annual_revenue', NULL, '0.00000000'),
	(18, 'assigned_user_id', NULL, '1'),
	(18, 'createdtime', NULL, '2018-10-18 04:42:50'),
	(18, 'modifiedby', NULL, '1'),
	(18, 'accrsocial', NULL, '123213'),
	(18, 'accrut', NULL, '123123'),
	(18, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(18, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(18, 'accisproveedor', NULL, '1'),
	(18, 'accmcontacto', NULL, 'Espont&aacute;neo Cliente'),
	(18, 'record_id', NULL, '12'),
	(18, 'record_module', NULL, 'Accounts'),
	(19, 'accountname', NULL, 'Robert m'),
	(19, 'account_no', NULL, 'ACC12'),
	(19, 'siccode', NULL, '123123'),
	(19, 'annual_revenue', NULL, '0.00000000'),
	(19, 'assigned_user_id', NULL, '1'),
	(19, 'createdtime', NULL, '2018-10-18 04:43:25'),
	(19, 'modifiedby', NULL, '1'),
	(19, 'accrsocial', NULL, '123213'),
	(19, 'accrut', NULL, '123123'),
	(19, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(19, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(19, 'accisproveedor', NULL, '1'),
	(19, 'accmcontacto', NULL, 'Espont&aacute;neo Cliente'),
	(19, 'record_id', NULL, '13'),
	(19, 'record_module', NULL, 'Accounts'),
	(20, 'accountname', NULL, 'sadasd'),
	(20, 'account_no', NULL, 'ACC13'),
	(20, 'siccode', NULL, '123123'),
	(20, 'annual_revenue', NULL, '0.00000000'),
	(20, 'assigned_user_id', NULL, '1'),
	(20, 'createdtime', NULL, '2018-10-18 04:45:40'),
	(20, 'modifiedby', NULL, '1'),
	(20, 'accrsocial', NULL, '123123'),
	(20, 'accrut', NULL, '123123'),
	(20, 'acctcompra', NULL, 'Compra Semestral'),
	(20, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(20, 'accisproveedor', NULL, '1'),
	(20, 'accmcontacto', NULL, 'Referido'),
	(20, 'record_id', NULL, '14'),
	(20, 'record_module', NULL, 'Accounts'),
	(21, 'accountname', NULL, 'sadasdk'),
	(21, 'account_no', NULL, 'ACC14'),
	(21, 'siccode', NULL, '123123'),
	(21, 'annual_revenue', NULL, '0.00000000'),
	(21, 'assigned_user_id', NULL, '1'),
	(21, 'createdtime', NULL, '2018-10-18 04:51:39'),
	(21, 'modifiedby', NULL, '1'),
	(21, 'accrsocial', NULL, '123123'),
	(21, 'accrut', NULL, '123123'),
	(21, 'acctcompra', NULL, 'Compra Semestral'),
	(21, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(21, 'accisproveedor', NULL, '1'),
	(21, 'accmcontacto', NULL, 'Referido'),
	(21, 'record_id', NULL, '15'),
	(21, 'record_module', NULL, 'Accounts'),
	(22, 'accountname', NULL, 'qssadsad'),
	(22, 'account_no', NULL, 'ACC15'),
	(22, 'siccode', NULL, '123123'),
	(22, 'annual_revenue', NULL, '0.00000000'),
	(22, 'assigned_user_id', NULL, '1'),
	(22, 'createdtime', NULL, '2018-10-18 04:54:56'),
	(22, 'modifiedby', NULL, '1'),
	(22, 'accrsocial', NULL, '12312'),
	(22, 'accrut', NULL, '123123'),
	(22, 'acctcompra', NULL, 'Compra Semestral'),
	(22, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(22, 'accisproveedor', NULL, '1'),
	(22, 'accmcontacto', NULL, 'Intermediario'),
	(22, 'record_id', NULL, '16'),
	(22, 'record_module', NULL, 'Accounts'),
	(23, 'accountname', NULL, 'qssadsadsad'),
	(23, 'account_no', NULL, 'ACC16'),
	(23, 'siccode', NULL, '123123'),
	(23, 'annual_revenue', NULL, '0.00000000'),
	(23, 'assigned_user_id', NULL, '1'),
	(23, 'createdtime', NULL, '2018-10-18 15:13:56'),
	(23, 'modifiedby', NULL, '1'),
	(23, 'accrsocial', NULL, '12312'),
	(23, 'accrut', NULL, '123123'),
	(23, 'acctcompra', NULL, 'Compra Semestral'),
	(23, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(23, 'accisproveedor', NULL, '1'),
	(23, 'accmcontacto', NULL, 'Intermediario'),
	(23, 'record_id', NULL, '17'),
	(23, 'record_module', NULL, 'Accounts'),
	(24, 'accountname', NULL, 'jkjhjkgjhgjh'),
	(24, 'account_no', NULL, 'ACC17'),
	(24, 'siccode', NULL, '123123'),
	(24, 'annual_revenue', NULL, '0.00000000'),
	(24, 'assigned_user_id', NULL, '1'),
	(24, 'createdtime', NULL, '2018-10-18 15:20:38'),
	(24, 'modifiedby', NULL, '1'),
	(24, 'accrsocial', NULL, '213123123'),
	(24, 'accrut', NULL, '123123'),
	(24, 'acctcompra', NULL, 'Compra Semestral'),
	(24, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(24, 'accisproveedor', NULL, '1'),
	(24, 'accmcontacto', NULL, 'Intermediario'),
	(24, 'record_id', NULL, '18'),
	(24, 'record_module', NULL, 'Accounts'),
	(25, 'accountname', NULL, '123123'),
	(25, 'account_no', NULL, 'ACC18'),
	(25, 'siccode', NULL, '123123'),
	(25, 'annual_revenue', NULL, '0.00000000'),
	(25, 'assigned_user_id', NULL, '1'),
	(25, 'createdtime', NULL, '2018-10-18 15:22:47'),
	(25, 'modifiedby', NULL, '1'),
	(25, 'accrsocial', NULL, '414212312'),
	(25, 'accrut', NULL, '123123'),
	(25, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(25, 'acctatencion', NULL, 'Atenci&oacute;n directa |##| A trav&eacute;s de agencia'),
	(25, 'accisproveedor', NULL, '1'),
	(25, 'accmcontacto', NULL, 'Otro'),
	(25, 'record_id', NULL, '19'),
	(25, 'record_module', NULL, 'Accounts'),
	(26, 'accountname', NULL, '123asdasd'),
	(26, 'account_no', NULL, 'ACC19'),
	(26, 'siccode', NULL, '123123'),
	(26, 'annual_revenue', NULL, '0.00000000'),
	(26, 'assigned_user_id', NULL, '1'),
	(26, 'createdtime', NULL, '2018-10-18 15:35:48'),
	(26, 'modifiedby', NULL, '1'),
	(26, 'accrsocial', NULL, '12313'),
	(26, 'accrut', NULL, '123123'),
	(26, 'acctcompra', NULL, 'Compra Semestral'),
	(26, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(26, 'accisproveedor', NULL, '1'),
	(26, 'accmcontacto', NULL, 'Otro'),
	(26, 'record_id', NULL, '20'),
	(26, 'record_module', NULL, 'Accounts'),
	(27, 'accountname', NULL, '1213123123'),
	(27, 'account_no', NULL, 'ACC20'),
	(27, 'siccode', NULL, '123123'),
	(27, 'annual_revenue', NULL, '0.00000000'),
	(27, 'assigned_user_id', NULL, '1'),
	(27, 'createdtime', NULL, '2018-10-18 15:53:35'),
	(27, 'modifiedby', NULL, '1'),
	(27, 'accrsocial', NULL, '123123123'),
	(27, 'accrut', NULL, '123123'),
	(27, 'acctcompra', NULL, 'Compra Semestral'),
	(27, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(27, 'accisproveedor', NULL, '1'),
	(27, 'accmcontacto', NULL, 'Intermediario'),
	(27, 'record_id', NULL, '21'),
	(27, 'record_module', NULL, 'Accounts'),
	(29, 'accountname', NULL, 'qwsqweqwe'),
	(29, 'account_no', NULL, 'ACC21'),
	(29, 'siccode', NULL, '123123'),
	(29, 'annual_revenue', NULL, '0.00000000'),
	(29, 'assigned_user_id', NULL, '1'),
	(29, 'createdtime', NULL, '2018-10-18 15:57:15'),
	(29, 'modifiedby', NULL, '1'),
	(29, 'accrsocial', NULL, '5856856'),
	(29, 'accrut', NULL, '12312312'),
	(29, 'acctcompra', NULL, 'Compra Semestral'),
	(29, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(29, 'accisproveedor', NULL, '1'),
	(29, 'accmcontacto', NULL, 'Otro'),
	(29, 'record_id', NULL, '22'),
	(29, 'record_module', NULL, 'Accounts'),
	(30, 'accountname', NULL, 'sasadsadasd'),
	(30, 'account_no', NULL, 'ACC22'),
	(30, 'siccode', NULL, '123123'),
	(30, 'annual_revenue', NULL, '0.00000000'),
	(30, 'assigned_user_id', NULL, '1'),
	(30, 'createdtime', NULL, '2018-10-18 16:07:26'),
	(30, 'modifiedby', NULL, '1'),
	(30, 'accrsocial', NULL, '123123123123'),
	(30, 'accrut', NULL, '123123'),
	(30, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(30, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(30, 'accisproveedor', NULL, '1'),
	(30, 'accmcontacto', NULL, 'Otro'),
	(30, 'record_id', NULL, '23'),
	(30, 'record_module', NULL, 'Accounts'),
	(31, 'siccode', '123123', '123124'),
	(32, 'siccode', '123124', '1231243'),
	(33, 'siccode', '1231243', '123123'),
	(34, 'siccode', '123123', '123124'),
	(35, 'siccode', '123124', '123123'),
	(36, 'siccode', '123123', '123124'),
	(37, 'siccode', '123124', '123123'),
	(38, 'siccode', '123123', '123124'),
	(39, 'accountname', NULL, 'asdasd'),
	(39, 'account_no', NULL, 'ACC23'),
	(39, 'phone', NULL, 'asdas'),
	(39, 'fax', NULL, 'asdasda'),
	(39, 'otherphone', NULL, 'asdasdasd'),
	(39, 'siccode', NULL, '123125'),
	(39, 'annual_revenue', NULL, '0.00000000'),
	(39, 'assigned_user_id', NULL, '1'),
	(39, 'createdtime', NULL, '2018-10-19 06:14:52'),
	(39, 'modifiedby', NULL, '1'),
	(39, 'accrsocial', NULL, '12312312'),
	(39, 'accrut', NULL, '123123'),
	(39, 'acctcompra', NULL, 'Compra Semestral'),
	(39, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(39, 'accisproveedor', NULL, '1'),
	(39, 'accmcontacto', NULL, 'Referido'),
	(39, 'record_id', NULL, '24'),
	(39, 'record_module', NULL, 'Accounts'),
	(40, 'accountname', NULL, 'Rodrigo Correa'),
	(40, 'account_no', NULL, 'ACC24'),
	(40, 'phone', NULL, '47212345'),
	(40, 'website', NULL, 'www.pagina.com'),
	(40, 'tickersymbol', NULL, 'ROD'),
	(40, 'email1', NULL, 'rodrigo@gmail.com'),
	(40, 'employees', NULL, '1'),
	(40, 'rating', NULL, 'Acquired'),
	(40, 'industry', NULL, 'Technology'),
	(40, 'siccode', NULL, '123123'),
	(40, 'accounttype', NULL, 'Customer'),
	(40, 'annual_revenue', NULL, '150000.00000000'),
	(40, 'emailoptout', NULL, '1'),
	(40, 'assigned_user_id', NULL, '1'),
	(40, 'createdtime', NULL, '2018-10-26 05:36:36'),
	(40, 'modifiedby', NULL, '1'),
	(40, 'accrsocial', NULL, '123456'),
	(40, 'accrut', NULL, '123123'),
	(40, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(40, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(40, 'accisproveedor', NULL, '1'),
	(40, 'accmcontacto', NULL, 'Referido'),
	(40, 'accmcreferido', NULL, 'Yo'),
	(40, 'record_id', NULL, '25'),
	(40, 'record_module', NULL, 'Accounts'),
	(41, 'accountname', NULL, 'Rodrigo Correa'),
	(41, 'account_no', NULL, 'ACC25'),
	(41, 'phone', NULL, '47212345'),
	(41, 'website', NULL, 'www.pagina.com'),
	(41, 'tickersymbol', NULL, 'ROD'),
	(41, 'email1', NULL, 'rodrigo@gmail.com'),
	(41, 'employees', NULL, '1'),
	(41, 'rating', NULL, 'Acquired'),
	(41, 'industry', NULL, 'Technology'),
	(41, 'siccode', NULL, '123123'),
	(41, 'accounttype', NULL, 'Customer'),
	(41, 'annual_revenue', NULL, '150000.00000000'),
	(41, 'emailoptout', NULL, '1'),
	(41, 'assigned_user_id', NULL, '1'),
	(41, 'createdtime', NULL, '2018-10-26 06:00:45'),
	(41, 'modifiedby', NULL, '1'),
	(41, 'accrsocial', NULL, '123456'),
	(41, 'accrut', NULL, '123123'),
	(41, 'acctcompra', NULL, 'Compra Anual |##| Compra Semestral'),
	(41, 'acctatencion', NULL, 'A trav&eacute;s de agencia'),
	(41, 'accisproveedor', NULL, '1'),
	(41, 'accmcontacto', NULL, 'Referido'),
	(41, 'accmcreferido', NULL, 'Yo'),
	(41, 'record_id', NULL, '26'),
...
-- Volcando datos para la tabla vtiger.vtiger_opportunity_type: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_opportunity_type` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_opportunity_type` (`opptypeid`, `opportunity_type`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_org_share_action2tab: ~100 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_parenttabrel: ~65 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_payment_duration: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_payment_duration` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_payment_duration` (`payment_duration_id`, `payment_duration`, `sortorderid`, `presence`) VALUES
	(1, 'Net 30 days', 0, 1),
	(2, 'Net 45 days', 1, 1),
	(3, 'Net 60 days', 2, 1);
...
-- Volcando datos para la tabla vtiger.vtiger_pbxmanager_phonelookup: ~1 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_pbxmanager_phonelookup` (`crmid`, `setype`, `fnumber`, `rnumber`, `fieldname`) VALUES
	(26, 'Accounts', '47212345', '54321274', 'phone');
...
INSERT IGNORE INTO `vtiger_postatus` (`postatusid`, `postatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Created', 0, 130, 0),
	(2, 'Approved', 0, 131, 1),
	(3, 'Delivered', 0, 132, 2),
	(4, 'Cancelled', 0, 133, 3),
...
-- Volcando datos para la tabla vtiger.vtiger_productcategory: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_productcategory` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_productcategory` (`productcategoryid`, `productcategory`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Hardware', 1, 136, 1),
	(3, 'Software', 1, 137, 2),
...
-- Volcando datos para la tabla vtiger.vtiger_profile2field: ~2.764 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_profile2standardpermissions: ~480 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_profile2tab: ~168 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_profile2utility: ~248 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_progress` (`progressid`, `progress`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, '10%', 1, 278, 2),
	(3, '20%', 1, 279, 3),
	(4, '30%', 1, 280, 4),
	(5, '40%', 1, 281, 5),
...
INSERT IGNORE INTO `vtiger_projectmilestonetype` (`projectmilestonetypeid`, `projectmilestonetype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_projectpriority` (`projectpriorityid`, `projectpriority`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'low', 1, 274, 2),
	(3, 'normal', 1, 275, 3),
	(4, 'high', 1, 276, 4);
...
INSERT IGNORE INTO `vtiger_projectstatus` (`projectstatusid`, `projectstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_projecttaskpriority` (`projecttaskpriorityid`, `projecttaskpriority`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'low', 1, 246, 2),
	(3, 'normal', 1, 247, 3),
	(4, 'high', 1, 248, 4);
...
INSERT IGNORE INTO `vtiger_projecttaskprogress` (`projecttaskprogressid`, `projecttaskprogress`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, '10%', 1, 250, 2),
	(3, '20%', 1, 251, 3),
	(4, '30%', 1, 252, 4),
	(5, '40%', 1, 253, 5),
...
-- Volcando datos para la tabla vtiger.vtiger_projecttaskstatus: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_projecttaskstatus` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_projecttaskstatus` (`projecttaskstatusid`, `projecttaskstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Open', 0, 290, 2),
...
INSERT IGNORE INTO `vtiger_projecttasktype` (`projecttasktypeid`, `projecttasktype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_projecttype` (`projecttypeid`, `projecttype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_quotestage` (`quotestageid`, `quotestage`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Created', 0, 139, 0),
	(2, 'Delivered', 0, 140, 1),
	(3, 'Reviewed', 0, 141, 2),
	(4, 'Accepted', 0, 142, 3),
...
-- Volcando datos para la tabla vtiger.vtiger_rating: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_rating` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_rating` (`rating_id`, `rating`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Acquired', 1, 145, 1),
	(3, 'Active', 1, 146, 2),
...
-- Volcando datos para la tabla vtiger.vtiger_recurringtype: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_recurringtype` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_recurringtype` (`recurringeventid`, `recurringtype`, `sortorderid`, `presence`) VALUES
	(2, 'Daily', 1, 1),
	(3, 'Weekly', 2, 1),
	(4, 'Monthly', 3, 1),
	(5, 'Yearly', 4, 1);
...
-- Volcando datos para la tabla vtiger.vtiger_recurring_frequency: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_recurring_frequency` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_recurring_frequency` (`recurring_frequency_id`, `recurring_frequency`, `sortorderid`, `presence`) VALUES
	(2, 'Daily', 1, 1),
	(3, 'Weekly', 2, 1),
	(4, 'Monthly', 3, 1),
	(5, 'Quarterly', 4, 1),
...
-- Volcando datos para la tabla vtiger.vtiger_relatedlists: ~131 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_relatedlists` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_relatedlists` (`relation_id`, `tabid`, `related_tabid`, `name`, `sequence`, `label`, `presence`, `actions`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_relatedlists_rb: ~14 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_relatedlists_rb` (`entityid`, `action`, `rel_table`, `rel_column`, `ref_column`, `related_crm_ids`) VALUES
	...
	(8, 'update', 'vtiger_crmentity', 'deleted', 'crmid', ''),
	(10, 'update', 'vtiger_crmentity', 'deleted', 'crmid', ''),
	(10, 'update', 'vtiger_crmentity', 'deleted', 'crmid', ''),
	(21, 'update', 'vtiger_crmentity', 'deleted', 'crmid', ''),
	(21, 'update', 'vtiger_crmentity', 'deleted', 'crmid', '');
...
-- Volcando datos para la tabla vtiger.vtiger_role2picklist: ~1.435 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_sales_stage` (`sales_stage_id`, `sales_stage`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
-- Volcando datos para la tabla vtiger.vtiger_salutationtype: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_salutationtype` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_salutationtype` (`salutationid`, `salutationtype`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Mr.', 1, 161, 1),
	(3, 'Ms.', 1, 162, 2),
	(4, 'Mrs.', 1, 163, 3),
	(5, 'Dr.', 1, 164, 4),
...
INSERT IGNORE INTO `vtiger_servicecategory` (`servicecategoryid`, `servicecategory`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Support', 1, 230, 2),
...
INSERT IGNORE INTO `vtiger_service_usageunit` (`service_usageunitid`, `service_usageunit`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Hours', 1, 226, 1),
	(2, 'Days', 1, 227, 2),
	(3, 'Incidents', 1, 228, 3);
...
-- Volcando datos para la tabla vtiger.vtiger_settings_blocks: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_settings_field: ~33 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_settings_field` (`fieldid`, `blockid`, `name`, `iconpath`, `description`, `linkto`, `sequence`, `active`, `pinned`) VALUES
	...
	(33, 4, 'LBL_DBCONNECTION', NULL, 'LBL_CONNECTIONEXTERNALDB', 'http://localhost/LuderePro/index.php?parent=Settings&module=Vtiger&view=DBExternal&block=4&fieldid=33', 12, 0, 0);
...
INSERT IGNORE INTO `vtiger_shippingtaxinfo` (`taxid`, `taxname`, `taxlabel`, `percentage`, `deleted`) VALUES
...
INSERT IGNORE INTO `vtiger_sostatus` (`sostatusid`, `sostatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Created', 0, 166, 0),
	(2, 'Approved', 0, 167, 1),
	(3, 'Delivered', 0, 168, 2),
	(4, 'Cancelled', 0, 169, 3);
...
-- Volcando datos para la tabla vtiger.vtiger_tab: ~44 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_tab` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_tab` (`tabid`, `name`, `presence`, `tabsequence`, `tablabel`, `modifiedby`, `modifiedtime`, `customized`, `ownedby`, `isentitytype`, `trial`, `version`, `parent`) VALUES
	(1, 'Dashboard', 0, 12, 'Dashboards', NULL, NULL, 0, 1, 0, 0, NULL, 'Analytics'),
	(2, 'Potentials', 1, 7, 'Potentials', NULL, NULL, 0, 0, 1, 0, NULL, 'Sales'),
	...
	(7, 'Leads', 1, 4, 'Leads', NULL, NULL, 0, 0, 1, 0, NULL, 'Sales'),
	...
	(13, 'HelpDesk', 1, 11, 'HelpDesk', NULL, NULL, 0, 0, 1, 0, NULL, 'Support'),
	(14, 'Products', 1, 8, 'Products', NULL, NULL, 0, 0, 1, 0, NULL, 'Inventory'),
	...
	(39, 'CustomerPortal', 1, -1, 'CustomerPortal', NULL, NULL, 0, 0, 0, 0, '1.4', ''),
...
-- Volcando datos para la tabla vtiger.vtiger_tab_info: ~31 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_taskpriority` (`taskpriorityid`, `taskpriority`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'High', 1, 170, 0),
	(2, 'Medium', 1, 171, 1),
	(3, 'Low', 1, 172, 2);
...
INSERT IGNORE INTO `vtiger_taskstatus` (`taskstatusid`, `taskstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_ticketcategories` (`ticketcategories_id`, `ticketcategories`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
...
INSERT IGNORE INTO `vtiger_ticketpriorities` (`ticketpriorities_id`, `ticketpriorities`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Low', 1, 182, 0),
	(2, 'Normal', 1, 183, 1),
	(3, 'High', 1, 184, 2),
	(4, 'Urgent', 1, 185, 3);
...
INSERT IGNORE INTO `vtiger_ticketseverities` (`ticketseverities_id`, `ticketseverities`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Minor', 1, 186, 0),
	(2, 'Major', 1, 187, 1),
	(3, 'Feature', 1, 188, 2),
	(4, 'Critical', 1, 189, 3);
...
INSERT IGNORE INTO `vtiger_ticketstatus` (`ticketstatus_id`, `ticketstatus`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Open', 0, 190, 0),
...
INSERT IGNORE INTO `vtiger_tracking_unit` (`tracking_unitid`, `tracking_unit`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(2, 'Hours', 1, 211, 2),
	(3, 'Days', 1, 212, 3),
	(4, 'Incidents', 1, 213, 4);
...
INSERT IGNORE INTO `vtiger_usageunit` (`usageunitid`, `usageunit`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Box', 1, 194, 0),
	(2, 'Carton', 1, 195, 1),
	(3, 'Dozen', 1, 196, 2),
	(4, 'Each', 1, 197, 3),
...
-- Volcando estructura para tabla vtiger.vtiger_userscf
CREATE TABLE IF NOT EXISTS `vtiger_userscf` (
  `usersid` int(11) NOT NULL,
  PRIMARY KEY (`usersid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_userscf: ~0 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_visibility` (`visibilityid`, `visibility`, `sortorderid`, `presence`) VALUES
	(1, 'Private', 0, 1),
	(2, 'Public', 1, 1);
...
INSERT IGNORE INTO `vtiger_wsapp` (`appid`, `name`, `appkey`, `type`) VALUES
	(1, 'vtigerCRM', '5bc753cf7c563', 'user');
...
-- Volcando datos para la tabla vtiger.vtiger_ws_operation: ~32 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_ws_operation_parameters: ~55 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_ws_referencetype: ~28 rows (aproximadamente)
