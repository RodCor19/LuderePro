...
-- Volcando estructura para tabla vtiger.vtiger_accmccombo
CREATE TABLE IF NOT EXISTS `vtiger_accmccombo` (
  `accmccomboid` int(11) NOT NULL AUTO_INCREMENT,
  `accmccombo` varchar(200) NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(11) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT '0',
  PRIMARY KEY (`accmccomboid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_accmccombo: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_accmccombo` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_accmccombo` (`accmccomboid`, `accmccombo`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Nuestra Empresa', 1, 0, 1),
	(2, 'Otra Empresa', 1, 0, 2),
	(3, 'Marketing', 1, 0, 3),
	(4, 'Administración', 1, 0, 4),
	(5, 'Ventas', 1, 0, 5),
	(6, 'RRHH', 1, 0, 6);
/*!40000 ALTER TABLE `vtiger_accmccombo` ENABLE KEYS */;

-- Volcando estructura para tabla vtiger.vtiger_accmccombo_seq
CREATE TABLE IF NOT EXISTS `vtiger_accmccombo_seq` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla vtiger.vtiger_accmccombo_seq: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `vtiger_accmccombo_seq` DISABLE KEYS */;
INSERT IGNORE INTO `vtiger_accmccombo_seq` (`id`) VALUES
	(18);
/*!40000 ALTER TABLE `vtiger_accmccombo_seq` ENABLE KEYS */;
...
-- Volcando datos para la tabla vtiger.vtiger_accmcontacto: ~10 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_accmcontacto` (`accmcontactoid`, `accmcontacto`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Gestión proactiva', 1, 0, 1),
	(2, 'Referido', 1, 0, 2),
	(3, 'Intermediario', 1, 0, 3),
	(4, 'Espontáneo Cliente', 1, 0, 4),
	(5, 'Otro', 1, 0, 5),
	(11, 'Gestión proactiva', 1, 0, 1),
	(12, 'Referido', 1, 0, 2),
	(13, 'Intermediario', 1, 0, 3),
	(14, 'Espontáneo Cliente', 1, 0, 4),
	(15, 'Otro', 1, 0, 5);
...
-- Volcando datos para la tabla vtiger.vtiger_acctatencion: ~4 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_acctatencion` (`acctatencionid`, `acctatencion`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Atención directa', 1, 0, 1),
	(2, 'A través de agencia', 1, 0, 2),
	(5, 'Atención directa', 1, 0, 1),
	(6, 'A través de agencia', 1, 0, 2);
...
-- Volcando datos para la tabla vtiger.vtiger_acctcompra: ~4 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_acctcompra` (`acctcompraid`, `acctcompra`, `presence`, `picklist_valueid`, `sortorderid`) VALUES
	(1, 'Compra Anual', 1, 0, 1),
	(2, 'Compra Semestral', 1, 0, 2),
	(7, 'Compra Anual', 1, 0, 1),
	(8, 'Compra Semestral', 1, 0, 2),
	(9, 'Compra de CP', 1, 0, 3);
...
-- Volcando datos para la tabla vtiger.vtiger_blocks: ~144 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_blocks` (`blockid`, `tabid`, `blocklabel`, `sequence`, `show_title`, `visible`, `create_view`, `edit_view`, `detail_view`, `display_status`, `iscustom`) VALUES
	...
	(122, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 7, 0, 0, 0, 0, 0, 1, 0),
	(123, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 8, 0, 0, 0, 0, 0, 1, 0),
	(124, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 9, 0, 0, 0, 0, 0, 1, 0),
	(125, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 10, 0, 0, 0, 0, 0, 1, 0),
	(126, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 11, 0, 0, 0, 0, 0, 1, 0),
	(127, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 12, 0, 0, 0, 0, 0, 1, 0),
	(128, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 13, 0, 0, 0, 0, 0, 1, 0),
	(129, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 14, 0, 0, 0, 0, 0, 1, 0),
	(130, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 15, 0, 0, 0, 0, 0, 1, 0),
	(131, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 16, 0, 0, 0, 0, 0, 1, 0),
	(132, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 17, 0, 0, 0, 0, 0, 1, 0),
	(133, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 18, 0, 0, 0, 0, 0, 1, 0),
	(134, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 19, 0, 0, 0, 0, 0, 1, 0),
	(135, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 20, 0, 0, 0, 0, 0, 1, 0),
	(136, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 21, 0, 0, 0, 0, 0, 1, 0),
	(137, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 22, 0, 0, 0, 0, 0, 1, 0),
	(138, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 23, 0, 0, 0, 0, 0, 1, 0),
	(139, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 24, 0, 0, 0, 0, 0, 1, 0),
	(140, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 25, 0, 0, 0, 0, 0, 1, 0),
	(141, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 26, 0, 0, 0, 0, 0, 1, 0),
	(142, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 27, 0, 0, 0, 0, 0, 1, 0),
	(143, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 28, 0, 0, 0, 0, 0, 1, 0),
	(144, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 29, 0, 0, 0, 0, 0, 1, 0),
	(145, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 30, 0, 0, 0, 0, 0, 1, 0),
	(146, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 31, 0, 0, 0, 0, 0, 1, 0),
	(147, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 32, 0, 0, 0, 0, 0, 1, 0),
	(148, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 33, 0, 0, 0, 0, 0, 1, 0),
	(149, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 34, 0, 0, 0, 0, 0, 1, 0),
	(150, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 35, 0, 0, 0, 0, 0, 1, 0),
	(151, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 36, 0, 0, 0, 0, 0, 1, 0),
	(152, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 37, 0, 0, 0, 0, 0, 1, 0),
	(153, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 38, 0, 0, 0, 0, 0, 1, 0),
	(154, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 39, 0, 0, 0, 0, 0, 1, 0),
	(155, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 40, 0, 0, 0, 0, 0, 1, 0),
	(156, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 41, 0, 0, 0, 0, 0, 1, 0),
	(157, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 42, 0, 0, 0, 0, 0, 1, 0),
	(158, 6, 'LBL_ACC_EJERCICIO_PASANTIA', 43, 0, 0, 0, 0, 0, 1, 0),
	(159, 6, 'LBL_ACC_EJERCICIO_PASANTIA_REDESSOCIALES', 44, 0, 0, 0, 0, 0, 1, 0);
...
-- Volcando datos para la tabla vtiger.vtiger_field: ~738 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_field` (`tabid`, `fieldid`, `columnname`, `tablename`, `generatedtype`, `uitype`, `fieldname`, `fieldlabel`, `readonly`, `presence`, `defaultvalue`, `maximumlength`, `sequence`, `block`, `displaytype`, `typeofdata`, `quickcreate`, `quickcreatesequence`, `info_type`, `masseditable`, `helpinfo`, `summaryfield`) VALUES
	...
	(6, 918, 'accmccombo', 'vtiger_account', 1, '15', 'accmccombo', 'accmccombo', 1, 2, '', 100, 9, 152, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 937, 'accrsocial', 'vtiger_account', 1, '1', 'accrsocial', 'accrsocial', 1, 2, '', 100, 1, 158, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 938, 'accrut', 'vtiger_account', 1, '1', 'accrut', 'accrut', 1, 2, '', 100, 2, 158, 1, 'N~M', 1, 0, 'BAS', 1, '', 0),
	(6, 939, 'acctcompra', 'vtiger_account', 1, '33', 'acctcompra', 'acctcompra', 1, 2, '', 100, 3, 158, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 940, 'acctatencion', 'vtiger_account', 1, '33', 'acctatencion', 'acctatencion', 1, 2, '', 100, 4, 158, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 941, 'accisproveedor', 'vtiger_account', 1, '56', 'accisproveedor', 'accisproveedor', 1, 2, '', 100, 5, 158, 1, 'C~O', 1, 0, 'BAS', 1, '', 0),
	(6, 942, 'accmcontacto', 'vtiger_account', 1, '15', 'accmcontacto', 'accmcontacto', 1, 2, '', 100, 6, 158, 1, 'V~M', 1, 0, 'BAS', 1, '', 0),
	(6, 943, 'accmcotro', 'vtiger_account', 1, '1', 'accmcotro', 'accmcotro', 1, 2, '', 100, 7, 158, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 944, 'accmcreferido', 'vtiger_account', 1, '1', 'accmcreferido', 'accmcreferido', 1, 2, '', 100, 8, 158, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 945, 'accmccombo', 'vtiger_account', 1, '15', 'accmccombo', 'accmccombo', 1, 2, '', 100, 9, 158, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 946, 'accredsocialtwitter', 'vtiger_account', 1, '1', 'accredsocialtwitter', 'accredsocialtwitter', 1, 2, '', 100, 1, 159, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 947, 'accredsocialfacebook', 'vtiger_account', 1, '1', 'accredsocialfacebook', 'accredsocialfacebook', 1, 2, '', 100, 2, 159, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 948, 'accredsocialinstagram', 'vtiger_account', 1, '1', 'accredsocialinstagram', 'accredsocialinstagram', 1, 2, '', 100, 3, 159, 1, 'V~O', 1, 0, 'BAS', 1, '', 0),
	(6, 949, 'accredsociallinkedin', 'vtiger_account', 1, '1', 'accredsociallinkedin', 'accredsociallinkedin', 1, 2, '', 100, 4, 159, 1, 'V~O', 1, 0, 'BAS', 1, '', 0);
...
INSERT IGNORE INTO `vtiger_language` (`id`, `name`, `prefix`, `label`, `lastupdated`, `sequence`, `isdefault`, `active`) VALUES
	(1, 'English', 'en_us', 'US English', '2018-10-06 06:43:50', NULL, 1, 1),
	(2, 'Arabic', 'ar_ae', 'Arabic', '2018-10-06 06:54:57', NULL, 0, 1),
	(3, 'Brazilian', 'pt_br', 'PT Brasil', '2018-10-06 06:51:16', NULL, 0, 1),
	(4, 'British English', 'en_gb', 'British English', '2018-10-06 06:49:34', NULL, 0, 1),
	(5, 'Deutsch', 'de_de', 'DE Deutsch', '2018-10-06 06:49:37', NULL, 0, 1),
	(6, 'Dutch', 'nl_nl', 'NL-Dutch', '2018-10-06 06:49:39', NULL, 0, 1),
	(7, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2018-10-06 06:51:17', NULL, 0, 1),
	(8, 'Hungarian', 'hu_hu', 'HU Magyar', '2018-10-06 06:49:45', NULL, 0, 1),
	(9, 'Italian', 'it_it', 'IT Italian', '2018-10-06 06:49:46', NULL, 0, 1),
	(10, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2018-10-06 06:49:47', NULL, 0, 1),
	(11, 'Język Polski', 'pl_pl', 'Język Polski', '2018-10-06 06:51:18', NULL, 0, 1),
	(12, 'Romana', 'ro_ro', 'Romana', '2018-10-06 06:51:17', NULL, 0, 1),
	(13, 'Russian', 'ru_ru', 'Russian', '2018-10-06 06:50:49', NULL, 0, 1),
	(14, 'Spanish', 'es_es', 'ES Spanish', '2018-10-06 06:50:58', NULL, 0, 1),
	(15, 'Swedish', 'sv_se', 'Swedish', '2018-10-06 06:54:58', NULL, 0, 1),
	(16, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2018-10-06 06:51:00', NULL, 0, 1);
...
-- Volcando datos para la tabla vtiger.vtiger_loginhistory: ~9 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_loginhistory` (`login_id`, `user_name`, `user_ip`, `logout_time`, `login_time`, `status`) VALUES
	(1, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-06 05:56:13', 'Signed in'),
	(2, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-08 17:28:22', 'Signed in'),
	(3, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-08 17:28:29', 'Signed in'),
	(4, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-08 17:28:29', 'Signed in'),
	(5, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-09 02:33:39', 'Signed in'),
	(6, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-09 02:33:47', 'Signed in'),
	(7, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-09 11:58:50', 'Signed in'),
	(8, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-10 14:04:01', 'Signed in'),
	(9, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-10 14:04:24', 'Signed in'),
	(10, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-16 15:40:57', 'Signed in'),
	(11, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-16 17:06:46', 'Signed in'),
	(12, 'admin', '::1', '0000-00-00 00:00:00', '2018-10-16 18:33:41', 'Signed in');
...
-- Volcando datos para la tabla vtiger.vtiger_parenttabrel: ~59 rows (aproximadamente)
...
-- Volcando datos para la tabla vtiger.vtiger_role2picklist: ~1.600 rows (aproximadamente)
...
INSERT IGNORE INTO `vtiger_users` (`id`, `user_name`, `user_password`, `user_hash`, `cal_color`, `first_name`, `last_name`, `reports_to_id`, `is_admin`, `currency_id`, `description`, `date_entered`, `date_modified`, `modified_user_id`, `title`, `department`, `phone_home`, `phone_mobile`, `phone_work`, `phone_other`, `phone_fax`, `email1`, `email2`, `secondaryemail`, `status`, `signature`, `address_street`, `address_city`, `address_state`, `address_country`, `address_postalcode`, `user_preferences`, `tz`, `holidays`, `namedays`, `workdays`, `weekstart`, `date_format`, `hour_format`, `start_hour`, `end_hour`, `activity_view`, `lead_view`, `imagename`, `deleted`, `confirm_password`, `internal_mailer`, `reminder_interval`, `reminder_next_time`, `crypt_type`, `accesskey`, `theme`, `language`, `time_zone`, `currency_grouping_pattern`, `currency_decimal_separator`, `currency_grouping_separator`, `currency_symbol_placement`, `phone_crm_extension`, `no_of_currency_decimals`, `truncate_trailing_zeros`, `dayoftheweek`, `callduration`, `othereventduration`, `calendarsharedtype`, `default_record_view`, `leftpanelhide`, `rowheight`, `defaulteventstatus`, `defaultactivitytype`, `hidecompletedevents`, `is_owner`) VALUES
	(1, 'admin', '$1$ad000000$hzXFXvL3XVlnUE/X.1n9t/', 'd41d8cd98f00b204e9800998ecf8427e', '#E6FAD8', 'Rodrigo Correa', 'Administrator', '', 'on', 1, '', '2018-10-06 03:06:46', NULL, NULL, '', '', '', '', '', '', '', 'rodrigo.l4.his@gmail.com', '', '', 'Active', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 'mm-dd-yyyy', '12', '00:00', '23:00', 'This Week', 'Today', '', 0, '$1$ad000000$nYTnfhTZRmUP.wQT9y1AE.', '1', '1 Minute', NULL, 'PHP5.3MD5', 'xzAZmnIZtDawPWFY', 'alphagrey', 'es_es', 'America/Montevideo', '123,456,789', '.', ',', '$1.0', '', '2', '1', 'Sunday', '5', '5', 'public', 'Summary', '0', 'medium', NULL, NULL, 0, '1');
...
INSERT IGNORE INTO `vtiger_wsapp` (`appid`, `name`, `appkey`, `type`) VALUES
	(1, 'vtigerCRM', '5bb84cdb510bc', 'user');
